...
def test1():
    ...
    for k in ["A","B","C","D","E","F"]:
        print(get_mins_maxes(k,c[k],eps)[0])
...
#
#     solns = {
#         "A": [((0.0, 0.0), ('A', 'min')), ((4.0, 4.0), ('A', 'max')), ((20.0, 100.0), ('A', 'min')), ((104.0, 104.0), ('A', 'max')), ((120.0, 196.0), ('A', 'min'))],"B" : [((0.0, 0.0), ('B', 'min')), ((8.0, 56.0), ('B', 'max')), ((76.0, 100.0), ('B', 'min')), ((108.0, 156.0), ('B', 'max')), ((176.0, 196.0), ('B', 'min'))]
#     }
#
#     for k in ["A","B"]:
#         assert(get_mins_maxes(k,c[k],eps)[0] == solns[k])
...
#
#     solns = {
#         "A": [((0.0, 0.0), ('A', 'min')), ((4.0, 8.0), ('A', 'max')), ((16.0, 100.0), ('A', 'min')),((104.0, 108.0), ('A', 'max')), ((112.0, 196.0), ('A', 'min'))],"B" : [((0.0, 4.0), ('B', 'min')), ((8.0, 60.0), ('B', 'max')), ((68.0, 100.0), ('B', 'min')), ((108.0, 160.0), ('B', 'max')), ((168.0, 196.0), ('B', 'min'))]
#     }
#
#     for k in ["A","B"]:
#         assert(get_mins_maxes(k,c[k],eps)[0] == solns[k])
